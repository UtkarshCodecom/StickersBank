...
public abstract class AddStickerPackApiActivity extends BaseActivity {
    ...
    protected void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
        ...
        intent.putExtra(StickerHandler.EXTRA_STICKER_PACK_ID, identifier);
        intent.putExtra(StickerHandler.EXTRA_STICKER_PACK_AUTHORITY, BuildConfig.CONTENT_PROVIDER_AUTHORITY_API);
        intent.putExtra(StickerHandler.EXTRA_STICKER_PACK_NAME, stickerPackName);
        try {
