...
public class PackApiCustom {
    ...
    @Expose
    private List<StickerApiCustom> stickers = null;

    public PackApiCustom() {
    }

    public PackApiCustom(StickerPackCustom stickerPack) {
        ...
        this.stickers = new ArrayList<StickerApiCustom>();
        for (int i = 0; i < stickerPack.getStickers().size(); i++) {
            StickerApiCustom stickerApi = new StickerApiCustom();
    ...
    public List<StickerApiCustom> getStickers() {
        return stickers;
    }

    public void setStickers(List<StickerApiCustom> stickers) {
