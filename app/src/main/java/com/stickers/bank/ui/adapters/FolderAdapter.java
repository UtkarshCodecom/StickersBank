...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.SimpleViewHolder> {
    ...
    public FolderAdapter(List<StickerFolder> projects, Context context, OnFolderItemClickListener onItemClickListener) {
        if (projects != null) {
