...
public class StickerContentProvider extends ContentProvider {
    ...
    private List<StickerPackCustom> stickerPackList = new ArrayList<>();
    ...
    public boolean onCreate() {
        ...
        for (StickerPackCustom stickerPack : getStickerPackList()) {
            ...
            if (stickerPack.getStickers() != null) {
                for (StickerCustom sticker : stickerPack.getStickers()) {
    ...
    private AssetFileDescriptor fetchFile(@NonNull Uri uri, @NonNull AssetManager am, @NonNull String fileName, @NonNull String identifier) {
        try {
            ...
            if (!file.exists()) {
                Log.d("fetFile", "StickerPackCustom dir not found");
            }
            Log.d("fetchFile", "StickerPackCustom " + file.getPath());
    ...
    private synchronized void readContentFile(@NonNull Context context) {
        if (Hawk.get("sticker_pack", new ArrayList<StickerPackCustom>()) != null) {
            stickerPackList.addAll(Hawk.get("sticker_pack", new ArrayList<StickerPackCustom>()));
        }
    }

    public List<StickerPackCustom> getStickerPackList() {
       /* if (stickerPackList == null) {
            readContentFile(Objects.requireNonNull(getContext()));
        }*/
        return (List) Hawk.get("whatsapp_sticker_packs", new ArrayList<StickerPackCustom>());
    }
    ...
    private Cursor getCursorForSingleStickerPack(@NonNull Uri uri) {
        ...
        return getStickerPackInfo(uri, new ArrayList<StickerPackCustom>());
    }

    @NonNull
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<StickerPackCustom> stickerPackList) {
        ...
        for (StickerPackCustom stickerPack : stickerPackList) {
